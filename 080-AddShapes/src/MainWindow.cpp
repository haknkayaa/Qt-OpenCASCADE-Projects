...
//        TDF_Label n
        ...
        TopoDS_Shape aTopoBox = BRepPrimAPI_MakeBox(20, 20, 20).Shape();
...
//        anAisBox->SetColor(Quantity_NOC_AZURE);
        ...
        treeWidgetItem->setText(0, "item-" + QString::number( ))
        NodeInteractive *nodeInteractive = new NodeInteractive()
