...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow) {
    ...
    connect(ui->check_show3DGrid, &QCheckBox::stateChanged, [this, myViewer]{
        myViewer->show3DGrid(!myViewer->isEnabled3DGrid());
    });
    connect(ui->check_showTrihedronCube, &QCheckBox::stateChanged, [this, myViewer]{
        myViewer->showTrihedronCube(!myViewer->isEnabledTrihedronCube());
    });
    connect(ui->check_showPerformanceStats, &QCheckBox::stateChanged, [this, myViewer]{
