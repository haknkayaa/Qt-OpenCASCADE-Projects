...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        stackedWidget = new QStackedWidget(widget_left);
        ...
        sizePolicy3.setHeightForWidth(xpos_button->sizePolicy().hasHeightForWidth());
        xpos_button->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(xneg_button->sizePolicy().hasHeightForWidth());
        xneg_button->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(ypos_button->sizePolicy().hasHeightForWidth());
        ypos_button->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(yneg_button->sizePolicy().hasHeightForWidth());
        yneg_button->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(zpos_button->sizePolicy().hasHeightForWidth());
        zpos_button->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(zneg_button->sizePolicy().hasHeightForWidth());
        zneg_button->setSizePolicy(sizePolicy3);
        ...
        menubar->setGeometry(QRect(0, 0, 1054, 20));
